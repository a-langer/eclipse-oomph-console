...
public class Parameters {
    ...
    public static final String INSTALLER_LAYOUT_ID = "oomph.installer.layout";
    ...
    public static final boolean TEXT_LAYOUT = VERBOSE ? VERBOSE
            : System.getProperty(INSTALLER_LAYOUT_ID, "progress").equals("text");
